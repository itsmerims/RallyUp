...
import { X, Trophy, TrendingUp, Activity, Award, Pencil } from 'lucide-react';
...
export default function PlayerInfoModal({ isOpen, playerId, players, matches, onEditPlayer, onClose }: PlayerInfoModalProps) {
      ...
      >
        ...
        <div className="p-6 pt-10 flex flex-col items-center text-center">
          ...
          <button
            ...
            className="mt-3 text-[11px] font-bold uppercase tracking-wider text-indigo-400 hover:text-indigo-300 border border-indigo-500/30 bg-indigo-500/10 rounded-lg px-4 py-1.5 transition-colors flex items-center gap-1.5"
          >
